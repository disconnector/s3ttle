...
/**
 * Info about a partner in a session — their display name and avatar.
 * Stored per-session so the backend can:
 * 1. Return names/avatars to the other partner's frontend
 * 2. Tell Claude each partner's real name for personalized facilitation
 */
...
export interface SendMessageRequest {
  ...
  displayName?: string;  // The sender's display name (e.g. "Rich")
  avatar?: string;       // The sender's emoji avatar (e.g. "😎")
  deviceId?: string;     // The sender's unique device identifier
}
